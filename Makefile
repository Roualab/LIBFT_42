...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/12/19 23:20:31 by rlabbaou          #+#    #+#              #
#    Updated: 2025/12/23 16:16:08 by rlabbaou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_tolower.c ft_toupper.c ft_isprint.c ft_isascii.c ft_isalnum.c \
		...
		ft_strncmp.c ft_strdup.c ft_calloc.c ft_memcpy.c ft_memmove.c ft_strchr.c \
		ft_strrchr.c ft_strnstr.c ft_bzero.c ft_memchr.c ft_memcmp.c \
		ft_memset.c ft_strlcpy.c ft_itoa.c ft_strjoin.c ft_striteri.c ft_strmapi.c \
